...
declare const DescribeHumanTaskUiCommand_base: {
    new (input: DescribeHumanTaskUiCommandInput): import("@smithy/core/client").CommandImpl<DescribeHumanTaskUiCommandInput, DescribeHumanTaskUiCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeHumanTaskUiCommandInput): import("@smithy/core/client").CommandImpl<DescribeHumanTaskUiCommandInput, DescribeHumanTaskUiCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
