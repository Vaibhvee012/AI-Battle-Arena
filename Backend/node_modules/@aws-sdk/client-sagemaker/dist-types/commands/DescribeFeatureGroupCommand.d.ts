...
declare const DescribeFeatureGroupCommand_base: {
    new (input: DescribeFeatureGroupCommandInput): import("@smithy/core/client").CommandImpl<DescribeFeatureGroupCommandInput, DescribeFeatureGroupCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeFeatureGroupCommandInput): import("@smithy/core/client").CommandImpl<DescribeFeatureGroupCommandInput, DescribeFeatureGroupCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
