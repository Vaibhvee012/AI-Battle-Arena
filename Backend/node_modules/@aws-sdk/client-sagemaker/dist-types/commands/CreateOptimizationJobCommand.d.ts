...
declare const CreateOptimizationJobCommand_base: {
    new (input: CreateOptimizationJobCommandInput): import("@smithy/core/client").CommandImpl<CreateOptimizationJobCommandInput, CreateOptimizationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateOptimizationJobCommandInput): import("@smithy/core/client").CommandImpl<CreateOptimizationJobCommandInput, CreateOptimizationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
