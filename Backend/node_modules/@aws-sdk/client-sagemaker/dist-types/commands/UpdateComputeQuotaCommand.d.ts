...
declare const UpdateComputeQuotaCommand_base: {
    new (input: UpdateComputeQuotaCommandInput): import("@smithy/core/client").CommandImpl<UpdateComputeQuotaCommandInput, UpdateComputeQuotaCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateComputeQuotaCommandInput): import("@smithy/core/client").CommandImpl<UpdateComputeQuotaCommandInput, UpdateComputeQuotaCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
