...
declare const CreateTrainingJobCommand_base: {
    new (input: CreateTrainingJobCommandInput): import("@smithy/core/client").CommandImpl<CreateTrainingJobCommandInput, CreateTrainingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTrainingJobCommandInput): import("@smithy/core/client").CommandImpl<CreateTrainingJobCommandInput, CreateTrainingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
