...
declare const UpdateMlflowTrackingServerCommand_base: {
    new (input: UpdateMlflowTrackingServerCommandInput): import("@smithy/core/client").CommandImpl<UpdateMlflowTrackingServerCommandInput, UpdateMlflowTrackingServerCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateMlflowTrackingServerCommandInput): import("@smithy/core/client").CommandImpl<UpdateMlflowTrackingServerCommandInput, UpdateMlflowTrackingServerCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
