...
declare const DescribeClusterNodeCommand_base: {
    new (input: DescribeClusterNodeCommandInput): import("@smithy/core/client").CommandImpl<DescribeClusterNodeCommandInput, DescribeClusterNodeCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeClusterNodeCommandInput): import("@smithy/core/client").CommandImpl<DescribeClusterNodeCommandInput, DescribeClusterNodeCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
