...
declare const ListClusterNodesCommand_base: {
    new (input: ListClusterNodesCommandInput): import("@smithy/core/client").CommandImpl<ListClusterNodesCommandInput, ListClusterNodesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListClusterNodesCommandInput): import("@smithy/core/client").CommandImpl<ListClusterNodesCommandInput, ListClusterNodesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
