...
declare const DescribePartnerAppCommand_base: {
    new (input: DescribePartnerAppCommandInput): import("@smithy/core/client").CommandImpl<DescribePartnerAppCommandInput, DescribePartnerAppCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribePartnerAppCommandInput): import("@smithy/core/client").CommandImpl<DescribePartnerAppCommandInput, DescribePartnerAppCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
