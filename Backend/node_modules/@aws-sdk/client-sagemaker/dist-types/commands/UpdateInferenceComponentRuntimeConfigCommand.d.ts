...
import type { UpdateInferenceComponentRuntimeConfigInput, UpdateInferenceComponentRuntimeConfigOutput } from "../models/models_5";
/**
 * @public
 */
...
declare const UpdateInferenceComponentRuntimeConfigCommand_base: {
    new (input: UpdateInferenceComponentRuntimeConfigCommandInput): import("@smithy/core/client").CommandImpl<UpdateInferenceComponentRuntimeConfigCommandInput, UpdateInferenceComponentRuntimeConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateInferenceComponentRuntimeConfigCommandInput): import("@smithy/core/client").CommandImpl<UpdateInferenceComponentRuntimeConfigCommandInput, UpdateInferenceComponentRuntimeConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
