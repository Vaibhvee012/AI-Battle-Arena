...
declare const CreateMlflowAppCommand_base: {
    new (input: CreateMlflowAppCommandInput): import("@smithy/core/client").CommandImpl<CreateMlflowAppCommandInput, CreateMlflowAppCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateMlflowAppCommandInput): import("@smithy/core/client").CommandImpl<CreateMlflowAppCommandInput, CreateMlflowAppCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
