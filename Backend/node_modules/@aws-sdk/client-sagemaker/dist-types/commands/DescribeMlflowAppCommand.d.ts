...
declare const DescribeMlflowAppCommand_base: {
    new (input: DescribeMlflowAppCommandInput): import("@smithy/core/client").CommandImpl<DescribeMlflowAppCommandInput, DescribeMlflowAppCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeMlflowAppCommandInput): import("@smithy/core/client").CommandImpl<DescribeMlflowAppCommandInput, DescribeMlflowAppCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
