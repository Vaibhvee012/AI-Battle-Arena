...
declare const BatchAddClusterNodesCommand_base: {
    new (input: BatchAddClusterNodesCommandInput): import("@smithy/core/client").CommandImpl<BatchAddClusterNodesCommandInput, BatchAddClusterNodesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchAddClusterNodesCommandInput): import("@smithy/core/client").CommandImpl<BatchAddClusterNodesCommandInput, BatchAddClusterNodesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
