...
declare const UpdateFeatureGroupCommand_base: {
    new (input: UpdateFeatureGroupCommandInput): import("@smithy/core/client").CommandImpl<UpdateFeatureGroupCommandInput, UpdateFeatureGroupCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateFeatureGroupCommandInput): import("@smithy/core/client").CommandImpl<UpdateFeatureGroupCommandInput, UpdateFeatureGroupCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
