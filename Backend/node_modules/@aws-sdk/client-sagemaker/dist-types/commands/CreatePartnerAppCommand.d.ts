...
declare const CreatePartnerAppCommand_base: {
    new (input: CreatePartnerAppCommandInput): import("@smithy/core/client").CommandImpl<CreatePartnerAppCommandInput, CreatePartnerAppCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePartnerAppCommandInput): import("@smithy/core/client").CommandImpl<CreatePartnerAppCommandInput, CreatePartnerAppCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
