...
declare const CreateClusterCommand_base: {
    new (input: CreateClusterCommandInput): import("@smithy/core/client").CommandImpl<CreateClusterCommandInput, CreateClusterCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateClusterCommandInput): import("@smithy/core/client").CommandImpl<CreateClusterCommandInput, CreateClusterCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
