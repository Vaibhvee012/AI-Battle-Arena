...
declare const ListHubsCommand_base: {
    new (input: ListHubsCommandInput): import("@smithy/core/client").CommandImpl<ListHubsCommandInput, ListHubsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListHubsCommandInput]): import("@smithy/core/client").CommandImpl<ListHubsCommandInput, ListHubsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
