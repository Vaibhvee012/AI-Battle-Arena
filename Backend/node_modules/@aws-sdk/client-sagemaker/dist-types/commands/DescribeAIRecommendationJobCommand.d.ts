...
declare const DescribeAIRecommendationJobCommand_base: {
    new (input: DescribeAIRecommendationJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeAIRecommendationJobCommandInput, DescribeAIRecommendationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeAIRecommendationJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeAIRecommendationJobCommandInput, DescribeAIRecommendationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
