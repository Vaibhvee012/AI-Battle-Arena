...
declare const ListHubContentVersionsCommand_base: {
    new (input: ListHubContentVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListHubContentVersionsCommandInput, ListHubContentVersionsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListHubContentVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListHubContentVersionsCommandInput, ListHubContentVersionsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
