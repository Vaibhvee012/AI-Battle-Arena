...
declare const DescribeHubContentCommand_base: {
    new (input: DescribeHubContentCommandInput): import("@smithy/core/client").CommandImpl<DescribeHubContentCommandInput, DescribeHubContentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeHubContentCommandInput): import("@smithy/core/client").CommandImpl<DescribeHubContentCommandInput, DescribeHubContentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
