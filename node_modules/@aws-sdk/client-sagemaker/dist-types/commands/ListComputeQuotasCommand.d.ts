...
declare const ListComputeQuotasCommand_base: {
    new (input: ListComputeQuotasCommandInput): import("@smithy/core/client").CommandImpl<ListComputeQuotasCommandInput, ListComputeQuotasCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListComputeQuotasCommandInput]): import("@smithy/core/client").CommandImpl<ListComputeQuotasCommandInput, ListComputeQuotasCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
