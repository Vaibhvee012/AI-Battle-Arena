...
declare const CreateFeatureGroupCommand_base: {
    new (input: CreateFeatureGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateFeatureGroupCommandInput, CreateFeatureGroupCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateFeatureGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateFeatureGroupCommandInput, CreateFeatureGroupCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
