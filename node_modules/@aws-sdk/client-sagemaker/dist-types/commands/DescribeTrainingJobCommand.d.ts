...
declare const DescribeTrainingJobCommand_base: {
    new (input: DescribeTrainingJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrainingJobCommandInput, DescribeTrainingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeTrainingJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrainingJobCommandInput, DescribeTrainingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
