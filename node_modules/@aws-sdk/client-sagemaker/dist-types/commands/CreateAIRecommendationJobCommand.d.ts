...
declare const CreateAIRecommendationJobCommand_base: {
    new (input: CreateAIRecommendationJobCommandInput): import("@smithy/core/client").CommandImpl<CreateAIRecommendationJobCommandInput, CreateAIRecommendationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateAIRecommendationJobCommandInput): import("@smithy/core/client").CommandImpl<CreateAIRecommendationJobCommandInput, CreateAIRecommendationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
