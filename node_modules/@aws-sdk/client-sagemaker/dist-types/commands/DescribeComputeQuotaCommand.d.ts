...
declare const DescribeComputeQuotaCommand_base: {
    new (input: DescribeComputeQuotaCommandInput): import("@smithy/core/client").CommandImpl<DescribeComputeQuotaCommandInput, DescribeComputeQuotaCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeComputeQuotaCommandInput): import("@smithy/core/client").CommandImpl<DescribeComputeQuotaCommandInput, DescribeComputeQuotaCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
