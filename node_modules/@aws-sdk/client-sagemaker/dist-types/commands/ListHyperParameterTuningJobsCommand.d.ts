...
declare const ListHyperParameterTuningJobsCommand_base: {
    new (input: ListHyperParameterTuningJobsCommandInput): import("@smithy/core/client").CommandImpl<ListHyperParameterTuningJobsCommandInput, ListHyperParameterTuningJobsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListHyperParameterTuningJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListHyperParameterTuningJobsCommandInput, ListHyperParameterTuningJobsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
