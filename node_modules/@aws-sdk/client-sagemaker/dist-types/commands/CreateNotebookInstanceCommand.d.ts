...
declare const CreateNotebookInstanceCommand_base: {
    new (input: CreateNotebookInstanceCommandInput): import("@smithy/core/client").CommandImpl<CreateNotebookInstanceCommandInput, CreateNotebookInstanceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateNotebookInstanceCommandInput): import("@smithy/core/client").CommandImpl<CreateNotebookInstanceCommandInput, CreateNotebookInstanceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
