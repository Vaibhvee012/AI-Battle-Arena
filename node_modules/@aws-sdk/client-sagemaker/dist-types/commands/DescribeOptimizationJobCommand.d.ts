...
declare const DescribeOptimizationJobCommand_base: {
    new (input: DescribeOptimizationJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeOptimizationJobCommandInput, DescribeOptimizationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeOptimizationJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeOptimizationJobCommandInput, DescribeOptimizationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
