...
declare const UpdatePartnerAppCommand_base: {
    new (input: UpdatePartnerAppCommandInput): import("@smithy/core/client").CommandImpl<UpdatePartnerAppCommandInput, UpdatePartnerAppCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdatePartnerAppCommandInput): import("@smithy/core/client").CommandImpl<UpdatePartnerAppCommandInput, UpdatePartnerAppCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
