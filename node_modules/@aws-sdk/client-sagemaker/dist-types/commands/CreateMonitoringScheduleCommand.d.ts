...
declare const CreateMonitoringScheduleCommand_base: {
    new (input: CreateMonitoringScheduleCommandInput): import("@smithy/core/client").CommandImpl<CreateMonitoringScheduleCommandInput, CreateMonitoringScheduleCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateMonitoringScheduleCommandInput): import("@smithy/core/client").CommandImpl<CreateMonitoringScheduleCommandInput, CreateMonitoringScheduleCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
