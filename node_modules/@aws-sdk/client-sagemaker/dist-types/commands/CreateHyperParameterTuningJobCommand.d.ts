...
declare const CreateHyperParameterTuningJobCommand_base: {
    new (input: CreateHyperParameterTuningJobCommandInput): import("@smithy/core/client").CommandImpl<CreateHyperParameterTuningJobCommandInput, CreateHyperParameterTuningJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateHyperParameterTuningJobCommandInput): import("@smithy/core/client").CommandImpl<CreateHyperParameterTuningJobCommandInput, CreateHyperParameterTuningJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
