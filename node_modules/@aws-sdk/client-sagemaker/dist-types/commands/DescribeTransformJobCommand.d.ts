...
declare const DescribeTransformJobCommand_base: {
    new (input: DescribeTransformJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeTransformJobCommandInput, DescribeTransformJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeTransformJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeTransformJobCommandInput, DescribeTransformJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
