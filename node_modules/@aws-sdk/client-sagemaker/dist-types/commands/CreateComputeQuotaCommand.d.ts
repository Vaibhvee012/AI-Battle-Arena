...
declare const CreateComputeQuotaCommand_base: {
    new (input: CreateComputeQuotaCommandInput): import("@smithy/core/client").CommandImpl<CreateComputeQuotaCommandInput, CreateComputeQuotaCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateComputeQuotaCommandInput): import("@smithy/core/client").CommandImpl<CreateComputeQuotaCommandInput, CreateComputeQuotaCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
